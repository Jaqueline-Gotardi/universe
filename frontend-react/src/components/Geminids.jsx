...
const Geminids = () => {
  ...
  <section className="tela-eventos-detalhe" id="detalhe-geminideas" style={{position: "relative", minHeight: "100vh"}}>
    <div className="space-background">
      <div className="stars"></div>
      </div> 
      
      <main className="container-geminids">
       <style>{`
        .container-geminids img {
        width: 100%; 
        max-width: 800px;       
        transform: scale(1.1);      
