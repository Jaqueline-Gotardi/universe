...
const Supermoon = () => {
  ...
  <section className="tela-eventos-detalhe" id="detalhe-superlua" style={{position: "relative", minHeight: "100vh"}}>
    <div className="space-background">
      <div className="stars"></div>
      </div> 
      
      <main className="container-superlua">
       <style>{`
        .container-superlua img {
        width: 100%; 
        max-width: 800px;       
        transform: scale(1.1);      
