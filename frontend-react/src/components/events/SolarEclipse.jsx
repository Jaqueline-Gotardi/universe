...
const SolarEclipse = () => {
  ...
  <section className="tela-eventos-detalhe" id="detalhe-eclipse-solar" style={{position: "relative", minHeight: "100vh"}}>
    <div className="space-background">
      <div className="stars"></div>
      </div> 
      
      <main className="container-solarEclipse">
       <style>{`
        .container-solarEclipse img {
        width: 100%; 
        max-width: 800px;       
        transform: scale(1.1);      
