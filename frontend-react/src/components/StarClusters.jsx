...
const StarClusters = () => {
  ...
  <section className="tela-eventos-detalhe" id="detalhe-agrupamentos-estelares" style={{position: "relative", minHeight: "100vh"}}>
    <div className="space-background">
      <div className="stars"></div>
      </div> 
      
      <main className="container-star-clusters">
       <style>{`
        .container-star-clusters img {
        width: 100%; 
        max-width: 800px;       
        transform: scale(1.1);      
