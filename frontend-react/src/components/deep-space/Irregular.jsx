...
const Irregular = () => {
  ...
  <section className="tela-eventos-detalhe" id="detalhe-irregular" style={{position: "relative", minHeight: "100vh"}}>
    <div className="space-background">
      <div className="stars"></div>
      </div> 
      
      <main className="container-irregular">
       <style>{`
        .container-irregular img {
        width: 100%; 
        max-width: 800px;       
        transform: scale(1.1);      
